...
<head>
  ...
  <link rel="stylesheet" href="chapter_landscape.css" type="text/css" />
...
<body>
  ...
  <div class="chapter_footer_landscape" data-region="footer" style=""><span class="chapter_footer_page-number" data-field="page-number" data-format="default">1</span>
