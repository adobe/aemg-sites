...
<head>
  ...
  <link rel="stylesheet" href="backcover_landscape.css" type="text/css" />
  <meta name="page-style" content="size:landscape;" />
...
<body>
  ...
  <div class="backcover-details-landscape" data-regio="content" style="
">
    ...
    <div class="backcover_organization-details">
      <div class="backcover_contact-container">
        ...
        <span class="backcover_org-contactnumbers"><img class="phone-icon img-icon" src="../../../aemguidesDALP/hi-tech/images/common/phone-img.png" /> 000 800 050 01888</span> <span class="backcover_org-emailaddresses"><a href="https://myaccount.google.com/email"><img class="email-icon-land img-icon" src="../../../aemguidesDALP/hi-tech/images/common/email-img.png" />info@nvidia.com</a></span>
      </div>
      ...
      <div class="backcover_socials-container">
        ...
        <span class="backcover_org-socials"><a href="https://www.instagram.com/accounts/login/?hl=en"><img class="phone-icon img-icon" src="../../../aemguidesDALP/hi-tech/images/common/insta-img.png" /> Instagram link</a></span>
      </div>
    </div>
  </div>
