...
<head>
  ...
  <meta name="page-style" content="size:A4 portrait; margin-bottom : 140px;" />
...
<body>
  <div data-region="header">
    <div class="toc_header">
      ...
      <img class="toc_header_logo" src="../../../aemguidesDALP/fsi/images/common/simp-firstpage-logo.png" />
    </div>
  </div>
