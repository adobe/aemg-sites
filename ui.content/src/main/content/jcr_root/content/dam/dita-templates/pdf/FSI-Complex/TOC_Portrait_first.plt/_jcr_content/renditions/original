...
<body>
  <div data-region="header">
    <div class="toc_header">
      ...
      <div class="toc_header_logo" style=""><img class="toc_header_logo" src="../../../aemguidesDALP/fsi/images/common/toc-header-logo.png" /></div>
    </div>
  </div>
  <div data-region="content" style=""><!-- <script type="text/javascript" src="draft.js"></script> -->
