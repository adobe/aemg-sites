...
<body>
  <div class="toc_header_landscape" data-region="header" style=""></div>
  <div class="landscape_complex_right" data-region="content" id="landscape_complex-right"><!-- <img src="landscape_complex.png" /> < style="width: 469px; height: 589px; cursor: nwse-resize;"  -->
    <div class="toc-img" style=""><img src="../../../aemguidesDALP/automotives/images/landscape/toc_landscape.png" /></div>
  </div>
