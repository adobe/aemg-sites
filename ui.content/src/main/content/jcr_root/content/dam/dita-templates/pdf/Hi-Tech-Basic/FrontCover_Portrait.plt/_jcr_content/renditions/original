...
<head>
  ...
  <link rel="stylesheet" href="frontcover.css" type="text/css" />
  <link rel="stylesheet" href="global.css" type="text/css" />
  <meta name="page-style" content="size:portrait;background-image:url(&#39;../../../aemguidesDALP/hi-tech/common/nvidia-graphics-logo.svg&#39;);background-size:50px 50px;margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;" />
...
<body>
  <div class="frontcover">
    ...
    <div class="frontcover_cover-image-wrapper">
      ...
      <div class="frontcover_textdata">
        <p><span class="frontcover_mainbooktitle"><span data-field="metadata" data-format="default" data-subtype="//prodinfo[1]/prodname">Product Name</span></span></p>
